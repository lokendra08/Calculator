...
/**
 * handles object creation This is factory of factory for AirthmaticOperation
 * and ICalculationService
 */
public abstract class AbstractFactory {
	 ...
	 */
	public abstract ICalculationService getCalculationService(String service, Stack<Double> values,
			Stack<Character> operators, IValidationService validationService);
}
