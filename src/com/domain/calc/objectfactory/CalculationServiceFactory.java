 ...
 * This is factory of classes implementing ICalculationService.
 */
public class CalculationServiceFactory extends AbstractFactory{
	...
	*/
	@Override
	public ICalculationService getCalculationService(String service,  Stack<Double> values, Stack<Character> operators, IValidationService validationService) {
